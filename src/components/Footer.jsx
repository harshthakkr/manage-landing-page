...
const Footer = () => {
  ...
  return (
    <div className="bg-very-dark-blue px-12 lg:px-32 pt-16 pb-8 md:py-16 flex flex-col md:flex-row justify-between items-center gap-10 md:gap-6 lg:gap-12">
      <div>
        <form
          onSubmit={(e) => {
            e.preventDefault();
        ...
        >
          <input
            ...
            className="p-4 rounded-full bg-very-light-gray text-sm focus:outline-bright-red"
          ></input>
          <button className="text-sm bg-bright-red hover:bg-red-300 text-very-light-gray rounded-full px-6 py-4">
            Go
          </button>
        </form>
        <footer className="mt-16 hidden md:block">
          <p className="text-dark-grayish-blue text-xs font-light">
            Copyright 2024. All Rights Reserved.
          </p>
        </footer>
      </div>
      <div className="flex gap-12 lg:gap-20 xl:gap-32">
        <div className="">
          <ul className="flex flex-col gap-4 text-gray-300 font-light text-xs">
            <li>
              <a
                href="#"
                className="hover:text-bright-red duration-200 cursor-pointer"
              >
                Home
              </a>
            </li>
      ...
      <div className="flex flex-col gap-8 md:gap-16">
        ...
        <div className="flex gap-3 items-center">
          <svg
            ...
            width="20"
            height="20"
            className="fill-white hover:fill-bright-red duration-200 cursor-pointer"
          >
      ...
      <footer className="mt-8 block md:hidden">
        <p className="text-dark-grayish-blue text-xs font-light">
          Copyright 2024. All Rights Reserved.
        </p>
      </footer>
